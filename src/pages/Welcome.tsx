  ...
  return (
    <div className="font-body">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-12" variants={itemVariants}>
            ...
            <motion.p 
              className="font-body text-xl md:text-2xl mb-2 max-w-4xl mx-auto opacity-90" 
              variants={itemVariants}
            >
            ...
            <motion.p 
              className="font-body text-lg mb-8 max-w-3xl mx-auto opacity-80" 
              variants={itemVariants}
            >
          ...
          <motion.div className="text-center" variants={itemVariants}>
            ...
            <motion.p 
              className="font-body text-lg mb-8 max-w-2xl mx-auto opacity-80" 
              variants={itemVariants}
            >
      ...
      <motion.section
        ...
        viewport={{ once: true }}
        variants={containerVariants}
        className="py-12 px-6 text-center bg-[#d0eaff]"
      >
