    ...
    <Card className="mb-6 border-brand-accent/20 shadow-lg">
      ...
      <CardContent>
          ...
          <div className="mb-4 p-3 bg-gradient-to-r from-green-50 to-brand-accent/10 border border-green-200 rounded-md">
            ...
            {breakIntervals.length > 0 && (
              <div className="mt-2 pt-2 border-t border-green-200">
                <div className="text-sm font-medium mb-2">Break Intervals:</div>
                {breakIntervals.map((interval, index) => (
                  <div key={interval.start.toISOString()} className="text-sm mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Button 
            size="lg" 
            className={`${isShiftActive ? 'bg-gray-400 hover:bg-gray-500' : 'bg-green-600 hover:bg-green-700'} text-white`} 
