      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input id="employerName" value={employerName} onChange={e => setEmployerName(e.target.value)} placeholder="Enter employer's name" required />
          </div>
          <div className="mx-0 my-0 px-[25px] py-[20px]">
            <label htmlFor="payRate" className="text-sm font-medium block mb-1">
              Pay Rate (£)
            </label>
            <Input id="payRate" type="number" value={payRate || ''} onChange={e => setPayRate(parseFloat(e.target.value) || 0)} placeholder="Enter pay rate" min="0" step="0.01" required />
          </div>
          <div>
          ...
          <div>
            ...
            <Input id="managerName" value={managerName} onChange={e => setManagerName(e.target.value)} placeholder="Enter manager's name" />
          </div>
          <div>
            <label className="text-sm font-medium block mb-1">
              Manager's Signature
            </label>
            <SignatureCanvas onSignatureChange={setIsSignatureEmpty} width={isMobile ? 300 : 380} height={180} onSignatureCapture={setStartSignatureData} />
          </div>
        </div>
