...
const Header: React.FC<HeaderProps> = ({ setSheetOpen, sheetOpen }) => {
    ...
    const fetchLogo = async () => {
      ...
      try {
        ...
        if (settings?.logo_url) {
          console.log("Logo URL found:", settings.logo_url);
              ...
              <SheetHeader>
                ...
                <SheetTitle className="text-left">
                  <span className="text-base font-medium text-gray-900">
                    {t('Welcome')}, {user?.user_metadata?.full_name || user?.email || 'User'}
                  </span>
                </SheetTitle>
              </SheetHeader>
